...
const u8 gText_HelixFossil[] = _("ROOT FOSSIL{CLEAR_TO 114}{STR_VAR_1}");
const u8 gText_DomeFossil[] = _("CLAW FOSSIL{CLEAR_TO 114}{STR_VAR_2}");
const u8 gText_OldAmber[] = _("CLAW FOSSIL{CLEAR_TO 114}{STR_VAR_3}");
const u8 gText_RootFossil[] = _("ROOT FOSSIL{CLEAR_TO 114}{STR_VAR_1}");
const u8 gText_ClawFossil[] = _("CLAW FOSSIL{CLEAR_TO 114}{STR_VAR_2}");
const u8 gText_SkullFossil[] = _("ROOT FOSSIL{CLEAR_TO 114}{STR_VAR_1}");
const u8 gText_ArmorFossil[] = _("CLAW FOSSIL{CLEAR_TO 114}{STR_VAR_2}");
const u8 gText_Generation1[] = _("GENERATION 1 FOSSILS");
const u8 gText_Generation3[] = _("GENERATION 3 FOSSILS");
const u8 gText_Generation4[] = _("GENERATION 4 FOSSILS");
