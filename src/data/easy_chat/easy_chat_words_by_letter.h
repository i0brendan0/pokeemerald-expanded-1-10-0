...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_AMUSING,
    EC_WORD_AN,
    EC_POKEMON_NATIONAL(ANCHORAGE),
    EC_WORD_AND,
    EC_WORD_ANGER,
    EC_WORD_ANGERS,
    EC_WORD_ANGRY,
    EC_WORD_ANIME,
    EC_POKEMON_NATIONAL(ANIMON),
    EC_POKEMON(ANORITH),
    EC_WORD_ANOTHER,
    EC_WORD_ANY,
    EC_WORD_ANYWHERE,
...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_POKEMON(BANETTE),
    EC_WORD_BANG,
    EC_POKEMON_NATIONAL(MIME_JR), // BARRIE
    EC_POKEMON_NATIONAL(MR_MIME), // BARRIERD
    EC_WORD_BASHFUL,
    EC_POKEMON_NATIONAL(BASTIODON),
    EC_POKEMON(BARBOACH),
    EC_WORD_BATH,
    EC_POKEMON_NATIONAL(BATSTUNG),
    EC_WORD_BATTLE,
    EC_WORD_BATTLE_ROOM,
    ...
    EC_POKEMON(BELLOYANT),
    EC_POKEMON_NATIONAL(BELLSPROUT),
    EC_POKEMON_NATIONAL(BELMITT),
    EC_WORD_BELONGS_TO,
    EC_WORD_BELOW,
    EC_WORD_BERRY,
    EC_WORD_BESIDE,
    ...
    EC_POKEMON_NATIONAL(BLOSSOMOLE),
    EC_WORD_BLUE,
    EC_WORD_BOARD,
    EC_WORD_BOLD,
    EC_POKEMON(BOMSOAKER),
...
const u16 gEasyChatWordsByLetter_O[] = {
    ...
    EC_POKEMON_NATIONAL(OWLDURN),
    EC_WORD_OWN,
};

const u16 gEasyChatWordsByLetter_P[] = {
    EC_POKEMON(PACHIRISU),
    EC_POKEMON_NATIONAL(PALKIA),
    EC_POKEMON(PANGSHI),
    EC_POKEMON_NATIONAL(PARA),
...
const u16 gEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_TALK,
    EC_WORD_TALKING,
    EC_POKEMON_NATIONAL(TANGEL),
    EC_POKEMON_NATIONAL(TANGELA),
    EC_POKEMON_NATIONAL(TANGRATH),
