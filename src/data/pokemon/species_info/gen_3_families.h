...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    #else
        .abilities = { ABILITY_RUN_AWAY, ABILITY_RUN_AWAY, ABILITY_RATTLED },
    #endif
    ...
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_KEEN_EYE, ABILITY_RAIN_DISH },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_EFFECT_SPORE, ABILITY_QUICK_FEET },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_EFFECT_SPORE, ABILITY_TECHNICIAN },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_CUTE_CHARM, ABILITY_WONDER_SKIN },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    #else
        .abilities = { ABILITY_PLUS, ABILITY_PICKUP, ABILITY_PLUS },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    #else
        .abilities = { ABILITY_MINUS, ABILITY_PICKUP, ABILITY_MINUS },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Minun"),
        .cryId = CRY_MINUN,
    ...
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OBLIVIOUS, ABILITY_PRANKSTER },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OBLIVIOUS, ABILITY_OWN_TEMPO },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Numel"),
        .cryId = CRY_NUMEL,
    ...
    #else
        .abilities = { ABILITY_WHITE_SMOKE, ABILITY_WHITE_SMOKE, ABILITY_SHELL_ARMOR },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #else
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_OWN_TEMPO, ABILITY_CONTRARY },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    #else
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SWIFT_SWIM, ABILITY_ADAPTABILITY },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #else
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_COLOR_CHANGE, ABILITY_COLOR_CHANGE },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_INSOMNIA, ABILITY_CURSED_BODY },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_PHANTASM, ABILITY_PRESSURE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_PRESSURE, ABILITY_JUSTIFIED },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Absol"),
    ...
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_INNER_FOCUS, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
