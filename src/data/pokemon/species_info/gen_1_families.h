...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_KEEN_EYE, ABILITY_BIG_PECKS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_POISON_POINT, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_POISON_POINT, ABILITY_SHEER_FORCE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_CUTE_CHARM, ABILITY_FRIEND_GUARD },
    #endif
    ...
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_CUTE_CHARM, ABILITY_UNAWARE },
    #endif
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_CUTE_CHARM, ABILITY_FRISK },
    #endif
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    #else
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_EFFECT_SPORE, ABILITY_DAMP },
    #endif
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Paras"),
        .cryId = CRY_PARAS,
    ...
    #else
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_SHIELD_DUST, ABILITY_WONDER_SKIN },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    #else
        .abilities = { ABILITY_PICKUP, ABILITY_PICKUP, ABILITY_UNNERVE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    #else
        .abilities = { ABILITY_LIMBER, ABILITY_LIMBER, ABILITY_UNNERVE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    #else
        .abilities = { ABILITY_GUTS, ABILITY_GUTS, ABILITY_STEADFAST },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    #else
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_SHELL_ARMOR, ABILITY_OVERCOAT },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
...
#define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_CURSED_BODY, ABILITY_PHANTASM}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_LEVITATE, ABILITY_PHANTASM}
#endif
    ...
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_INSOMNIA, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_KEEN_EYE, ABILITY_INNER_FOCUS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_VENOMOUS, ABILITY_LEVITATE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_POISON_POINT, ABILITY_DAMP },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #else
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_SOUNDPROOF, ABILITY_TECHNICIAN },
    #endif
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Barrie"),
        .cryId = CRY_MIME_JR,
    ...
    #else
        .abilities = { ABILITY_SWARM, ABILITY_SWARM, ABILITY_STEADFAST },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    #else
        .abilities = { ABILITY_SWARM, ABILITY_SWARM, ABILITY_LIGHT_METAL },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OBLIVIOUS, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_OBLIVIOUS, ABILITY_DRY_SKIN },
    #endif
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Jynx"),
        .cryId = CRY_JYNX,
    ...
    #else
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_HYPER_CUTTER, ABILITY_MOXIE },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    #else
        .abilities = { ABILITY_RUN_AWAY, ABILITY_RUN_AWAY, ABILITY_ANTICIPATION },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Eevee"),
        .cryId = CRY_EEVEE,
    ...
    #else
        .abilities = { ABILITY_TRACE, ABILITY_TRACE, ABILITY_ANALYTIC },
    #endif
        .bodyColor = BODY_COLOR_PINK,
