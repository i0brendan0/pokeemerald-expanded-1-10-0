static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SUBEARTH_TOWN - 1] = {MAP_GROUP(SUBEARTH_TOWN), MAP_NUM(SUBEARTH_TOWN), 14, 12},
    [HEAL_LOCATION_EASTEDGE_TOWN - 1] = {MAP_GROUP(EASTEDGE_TOWN), MAP_NUM(EASTEDGE_TOWN), 7, 17},
};
