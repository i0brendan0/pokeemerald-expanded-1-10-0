...
enum {
    ...
    NATIONAL_DEX_PLUX,
    NATIONAL_DEX_WOLFMAN, // Move near korota/raitora
    NATIONAL_DEX_WARWOLF, // Move near korota/raitora
    NATIONAL_DEX_SWIEVEL,
    NATIONAL_DEX_x_WOOPER_x,
    NATIONAL_DEX_TWINZ,
    // Custom Evos x_MODIFY_x
    NATIONAL_DEX_OWLDURN,
    NATIONAL_DEX_TANGRATH, // Move near tangrath
    ...
    // Custom Babies x_MODIFY_x
    NATIONAL_DEX_TRIFOX,
    NATIONAL_DEX_TANGEL, // Move near tangel
    NATIONAL_DEX_GOLPY,
    NATIONAL_DEX_PARA,
    NATIONAL_DEX_CHIKS,
    NATIONAL_DEX_MEOWSY,
...
#define KANTO_DEX_END     NATIONAL_DEX_MEW
#define JOHTO_DEX_END     NATIONAL_DEX_CELEBI
#define HOENN_DEX_END     NATIONAL_DEX_DEOXYS
#define SINNOH_DEX_END    NATIONAL_DEX_ARCEUS
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_x_CELEBI_x
#else
...
// Hoenn Pokédex order x_MODIFY_x
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_TREECKO,
    HOENN_DEX_GROVYLE,
